...
public class RegUtil {
     ...
     */
    private static final Pattern PATTERN_USERNAME = Pattern.compile(REG_USERNAME);

    /**
     * 普通用户11位手机号
     * 10、11、12开头的号码已分配给特定机构
     */
    private static final Pattern PATTERN_MOBILE = Pattern.compile(REG_MOBILE);

    /**
     * 邮箱
     * http://emailregex.com/
     */
    private static final Pattern PATTERN_EMAIL = Pattern.compile(REG_EMAIL);
    ...
    public static boolean username(String v) {
        ...
        Matcher m = PATTERN_USERNAME.matcher(v);
        return m.matches();
    }
    ...
    public static boolean mobile(String v) {
        ...
        Matcher m = PATTERN_MOBILE.matcher(v);
        return m.matches();
    }
    ...
    public static boolean email(String v) {
        ...
        Matcher m = PATTERN_EMAIL.matcher(v);
        return m.matches();
    }
